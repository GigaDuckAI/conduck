...
└── Conduck/                                            # Xcode project container
    ...
    │
    ├── ConduckTests/                                   # XCTest ~2100 cases, 0-failure green on iOS Sim; keychain-touching cases XCTSkip/guard on unsigned; signed run (`-allowProvisioningUpdates`) only needed for live-Keychain assertions
