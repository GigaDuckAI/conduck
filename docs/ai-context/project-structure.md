...
| `Services/Workboard/` | The Workboard's private asset vault, capture draining/recovery, immutable prompt and dispatch preparation, on-device brief shaping, and deterministic briefing. Network dispatch remains in the existing conversation/gateway lane. |
