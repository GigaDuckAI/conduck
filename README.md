...
**Work is a desk, not a conversation.** Alongside chat, Conduck keeps one private desk for what you want to hold on to: notes, voice memos, screenshots and files. Nothing on it ever starts a conversation or becomes a gateway turn — no AI is asked about it. A voice note's audio does go to the speech provider you chose, and only to bring its words back. Add to it from the desk itself or the share sheet on iPhone, iPad and Mac; with the Shortcuts actions *Add Files to Work* and *Record a Note to Work*; from the Mac menu bar with ⌃⌘W or *Capture to Work…*; from your wrist, where Ask offers *Add to Work* and your iPhone saves it for you; and in the car with *Add to Work*, one spoken note, hands free. A voice note plays back before its words arrive. Cards reach your other devices through your own private iCloud, and a file too large to sync stays on the device that has it.
