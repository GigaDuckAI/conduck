            ...
            Task {
                ...
                do {
                    if let userMessageID {
                        ...
                        // pre-upgrade task) → unstamped, and that same dispatch
                        // named no folder either: the two are minted together
                        // (`outboxKey(forLane:conversationID:)`).
                        //
                        // `outputBoxKey` is the folder this dispatch named, read
