...
final class ConversationsModelMigrationTests: XCTestCase {
    ...
    /// The model the APP opens is v16. A pointer left on an older version would
    ...
    /// to keep.
    func testTheCurrentModelVersionIsV16() throws {
        ...
        XCTAssertEqual(plist["NSManagedObjectModel_CurrentVersionName"] as? String, "Conversations 16")
    }
