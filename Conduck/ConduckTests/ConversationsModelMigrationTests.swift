...
final class ConversationsModelMigrationTests: XCTestCase {
    ...
    func testV8StoreMigratesToV9WithNilOutputDeliveryCensus() async throws {
        ...
        let current = try requiredModel(named: "Conversations 15.mom")
        let conversationID = UUID()
        let messageID = UUID()
    ...
    /// The model the APP opens is v15. A pointer left on an older version would
    ...
    /// to keep.
    func testTheCurrentModelVersionIsV15() throws {
        ...
        XCTAssertEqual(plist["NSManagedObjectModel_CurrentVersionName"] as? String, "Conversations 15")
    }
