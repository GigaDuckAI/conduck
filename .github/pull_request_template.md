...
- [ ] No gateway URLs/hostnames, API keys, tokens, transcripts, replies or file names added to any log, error message or notification; new `print`/`debugPrint`/`dump` calls are inside `#if DEBUG` — see [CONTRIBUTING.md](https://github.com/gigaduckai/conduck/blob/main/CONTRIBUTING.md#logging-and-privacy).
